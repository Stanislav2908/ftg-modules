...
class ModulesLinkMod(loader.Module):
    ...
    async def mlcmd(self, message):
        ...
        try:
            ...
            logger.info(f"Request to find module named {args} was failed due to:", exc_info=True)
    ...
    async def mlccmd(self, message):
        ...
        try:
            ...
            logger.info(f"Request to find module with command {args} was failed due to:", exc_info=True)
            await utils.answer(message, "<b>Module was not found</b>")